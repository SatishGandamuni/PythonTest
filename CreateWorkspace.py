...
workspace_params = {
    'location': Location,
    'managed_resource_group_id':'/subscriptions/'+ subscription_id + '/resourceGroups/'+'databricks-rg-'+WORKSPACE_NAME[0:4]+ (str(ran.lower())),
    # 'managed_resource_group_id': '/subscriptions/7a9974b4-6ef3-490d-a02d-b9b3a07332f6/resourceGroups/databricks-rg-myDWcl7e17ndfp',
    'sku' : Sku(name = SKU)
    }
...
workspace_params.update(tags={'PlainVanilla': 'Workspace'})
client.workspaces.begin_create_or_update(resource_group, WORKSPACE_NAME, workspace_params)